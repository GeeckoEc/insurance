...
import ViewModel from './EliminarAgenteViewModel';

export const EliminarAgenteScreen = () => {
    ...
    return (
        <View style={Estilos.Contenedor}>
            ...
            <View style={Estilos.Formulario}>
                <Text style={Estilos.Titulo}>Eliminar el agente</Text>
                <Text style={Estilos.Descripcion}>¿Está seguro de que desea eliminar el agente con el siguiente ID?</Text>
                <Campo 
