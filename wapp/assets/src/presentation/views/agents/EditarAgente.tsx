...
import ViewModel from "./EditarAgenteViewModel";
import { StyleSheet, Text, View } from "react-native";

export const EditarAgenteScreen = () => {
    ...
    return (
        <View style={Estilos.Contenendor}>
            ...
            <View style={Estilos.Formulario}>
                <Text style={Estilos.Titulo}>Editar Agente</Text>
                <Text style={Estilos.Descripción}>A continuación realice los cambios necesarios en la información del agente.</Text>
                <Campo 
                    icono="id-badge-solid"
                    etiqueta="ID del Agente"
                    consejo="No eliminar el ID del agente."
                    valor={id}
                    propiedad="id"
                    teclado="default"
                    entradaSegura={false}
