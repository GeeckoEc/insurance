...
import ViewModel from './EliminarPolizaViewModel';

export const EliminarPolizaScreen = () => {
    ...
    return (
        <View style={Estilos.Contenedor}>
            ...
            <View style={Estilos.Formulario}>
                <Text style={Estilos.Titulo}>Eliminar la Poliza</Text>
                <Text style={Estilos.Descripcion}>¿Está seguro de que desea eliminar la Poliza con el siguiente ID?</Text>
                <Campo 
